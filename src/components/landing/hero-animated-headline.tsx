...
export function HeroAnimatedHeadline() {
  ...
  return (
    <div className="relative mx-auto w-full max-w-7xl px-5 md:px-8">
      {/* Background graphic elements — static, no animation cost */}
      ...
      <div className="flex flex-col items-center py-14 text-center md:py-20">
        {/* Badge — CSS reveal */}
        <div className="hero-anim hero-delay-1 mb-8 inline-flex items-center gap-2 rounded-full border border-[#22D3EE]/30 bg-[#22D3EE]/8 px-5 py-2 text-[11px] font-semibold uppercase tracking-[0.18em] text-[#22D3EE]">
        ...
        {/* H1 — LCP element: NO opacity animation, visible from first paint */}
        <h1 className="max-w-5xl text-5xl font-black leading-[1.02] tracking-tight md:text-7xl lg:text-8xl">
        ...
        {/* Profession carousel — LazyMotion (domAnimation ≈16KB) for AnimatePresence only */}
        <div className="hero-anim hero-delay-3 mt-6 flex items-center justify-center gap-3 text-xl text-[#EAF0FF]/60 md:text-2xl">
        ...
        {/* Subtitle — CSS reveal */}
        <p className="hero-anim hero-delay-4 mx-auto mt-6 max-w-2xl text-base leading-relaxed text-[#EAF0FF]/55 md:text-lg">
        ...
        {/* Price anchor pill — CSS reveal */}
        <div className="hero-anim hero-delay-4 mt-9">
        ...
        {/* CTAs — CSS reveal */}
        <div className="hero-anim hero-delay-5 mt-6 flex flex-col items-center gap-4 sm:flex-row">
          <Link
            href="/quero-comecar"
        ...
        {/* Trust badges — CSS reveal */}
        <div className="hero-anim hero-delay-6 mt-5 flex flex-wrap items-center justify-center gap-x-6 gap-y-2">
          {[
        ...
        {/* Stat cards — CSS reveal, plain divs */}
        <div className="hero-anim hero-delay-7 mt-14 grid grid-cols-3 gap-4 md:gap-6">
